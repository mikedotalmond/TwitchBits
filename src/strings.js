settings.strings = {
    ...
    // social links etc
    "bot_!work": ["Mike is a freelance creative programmer of graphics, audio, apps, web things, and general prettiness. Get in touch if you'd like to work together ❤"],
